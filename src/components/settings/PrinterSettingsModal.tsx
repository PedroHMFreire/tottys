        ...
        <div className="w-full sm:max-w-md lg:max-w-xl bg-white rounded-t-2xl sm:rounded-2xl shadow-xl max-h-[92vh] flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 pt-4 pb-3 border-b border-slate-100 flex-shrink-0">
            <div className="flex items-center gap-2">
              <Printer size={17} className="text-[#1E40AF]" />
              ...
              <>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {([58, 80] as const).map(w => (
                      <button
                        ...
                        className={`py-3 rounded-xl border-2 text-sm font-medium transition-colors cursor-pointer ${form.paper_width === w ? 'border-[#1E40AF] bg-[#EFF6FF] text-[#1E40AF]' : 'border-slate-200 text-slate-600 hover:border-slate-300'}`}
                      >
                        {w} mm
                      </button>
                    ))}
                  ...
                  <div className="flex items-center gap-3">
                    {[1, 2, 3].map(n => (
                      <button
                        ...
                        className={`w-12 h-10 rounded-xl border-2 text-sm font-medium transition-colors cursor-pointer ${form.copies === n ? 'border-[#1E40AF] bg-[#EFF6FF] text-[#1E40AF]' : 'border-slate-200 text-slate-600 hover:border-slate-300'}`}
                      >
                        {n}
                      </button>
                    ))}
                ...
                <div className="flex items-center justify-between py-2 border-t border-slate-100">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors cursor-pointer ${form.auto_print ? 'bg-[#1E40AF]' : 'bg-slate-200'}`}
                  >
